...
def batch_to_device(batch, device="cpu", non_blocking=True):
    def _func(tensor):
...
def load_image(path, resize=None, **kwargs):
...
def match_pair(extractor, matcher, image0, image1, device="cpu", **preprocess):
